...
| P3 | VM registry, operations, admission reservations, runtime interface + fake runtime, lifecycle event emission | §5, §6, R-01, R-02, R-09 partial, R-10 partial | in progress — store/runtime/triggers/API/CLI landed, smoke green; vm-batches (§6.3) pending |
