...
var registry = []KindInfo{
	...
	},
	{
		...
		Semantics:     "A filesystem notification reported a new directory entry in the monitored guest scope.",
		Caveats:       []string{"Creation is not proof that file content was written; retained handles and raw names identify the reported entry.", "Notification queues can overflow; paths resolved after capture are inferred and may no longer name the captured object."},
	},
	{
		Kind:          "fs.close_write",
		Family:        "fs",
		SchemaVersion: 1,
		Provenance:    GuestReported,
		Semantics:     "A file opened for writing was closed in the monitored guest scope.",
		Caveats:       []string{"Close-write is not proof of changed content; content comparison is required for a content-change claim.", "Notification queues can overflow; paths resolved after capture are inferred and may no longer name the captured object."},
	},
	{
		Kind:          "fs.rename",
		Family:        "fs",
		SchemaVersion: 1,
		Provenance:    GuestReported,
		Semantics:     "A filesystem notification reported a moved or renamed directory entry.",
		Caveats:       []string{"Reported old and new parent handles and names remain evidence even when later path resolution fails.", "Notification queues can overflow; paths resolved after capture are inferred and may no longer name the captured object."},
	},
	{
		Kind:          "fs.delete",
		Family:        "fs",
		SchemaVersion: 1,
		Provenance:    GuestReported,
		Semantics:     "A filesystem notification reported removal of a directory entry.",
		Caveats:       []string{"Unlinking a name does not prove removal of every hard link or closure of an already-open file.", "Notification queues can overflow; paths resolved after capture are inferred and may no longer name the captured object."},
	},
	{
		Kind:          "fs.metadata",
		Family:        "fs",
		SchemaVersion: 1,
		Provenance:    GuestReported,
		Semantics:     "A filesystem notification reported an attribute change in the monitored guest scope.",
		Caveats:       []string{"The notification does not identify exact before/after metadata values; a manifest comparison supplies those values.", "Notification queues can overflow; paths resolved after capture are inferred and may no longer name the captured object."},
	},
	{
		Kind:          "fs.coverage",
		Family:        "fs",
		SchemaVersion: 1,
		Provenance:    GuestReported,
		Semantics:     "The guest filesystem collector reported its enabled scope or a coverage change.",
		Caveats:       []string{"Coverage is guest-reported; unsupported filesystems and failed marks are gaps, not evidence of no file activity.", "Notification queues can overflow; paths resolved after capture are inferred and may no longer name the captured object."},
	},
	{
		Kind:          "fs.loss",
		Family:        "fs",
		SchemaVersion: 1,
		Provenance:    GuestReported,
		Semantics:     "The guest filesystem collector reported lost observation or a malformed event interval.",
		Caveats:       []string{"An unknown loss span is not zero lost events; recovery does not reconstruct notifications already lost.", "Notification queues can overflow; paths resolved after capture are inferred and may no longer name the captured object."},
	},
	{
		Kind:          "fs.modify",
		Family:        "fs",
